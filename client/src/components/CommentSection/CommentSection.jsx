    ...
    <div className="max-w-2xl mx-auto px-4">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">
          Discussion ({movie?.comments?.length})
        </h2>
      </div>
      <form className="mb-6">
        ...
        <button
          ...
          className= "rounded ml-1  inline-flex items-center py-2 px-6 text-xs font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800"
        >
          Post comment
        </button>
      </form>
...
//     <article classNameName="p-6 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
//         <footer class="flex justify-between items-center mb-2">
//         {movie && movie.comments.map((c, index) => (
